...
<div class="container-fluid">
 <div class="page-header">
              <h4 class="text-cente" style="text-align: center;"> REPORTE MENSUAL DE CONFIRMACIONES</h4>
            </div>
        </div>
                            <table  class="table table-striped table-bordered" style=" width: 90%; border-collapse: collapse;border: 1px solid #000; margin: 0 auto;">
                                    <thead style="background-color: #C0C0C0; font-size: 15px;"><tr>
                                            ...
                                            <th  style="width: 25%; text-align: center;vertical-align: top; border: 1px solid #000; border-spacing: 0;">TOTAL DE CONFIRMACIONES</th>
                                        </tr>
                                    </thead>
